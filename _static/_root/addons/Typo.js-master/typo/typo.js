...
var Typo = function (dictionary, affData, wordsData, settings) {
	...
	if (dictionary) {
		...
		if (this.platform == "chrome") {
			if (!affData) affData = this._readFile("/static/Typo.js-master/typo/dictionaries/" + dictionary + "/" + dictionary + ".aff", "utf-8");
			if (!wordsData) wordsData = this._readFile("/static/Typo.js-master/typo/dictionaries/" + dictionary + "/" + dictionary + ".dic", "utf-8");
			//if (!affData) affData = this._readFile(chrome.extension.getURL("lib/typo/dictionaries/" + dictionary + "/" + dictionary + ".aff"));
			//if (!wordsData) wordsData = this._readFile(chrome.extension.getURL("lib/typo/dictionaries/" + dictionary + "/" + dictionary + ".dic"));
		} else {
			var path = settings.dictionaryPath || '';
			
			if (!affData) affData = this._readFile(path + "/" + dictionary + "/" + dictionary + ".aff", "utf-8");
			if (!wordsData) wordsData = this._readFile(path + "/" + dictionary + "/" + dictionary + ".dic", "utf-8");
		}
